...
casefile = "case_256589_259575.txt"
...
outdir = "./Results/case_256589_259575_500lvls/"
#dp_y[0] *= 1e3
#dp_y[-1] *= 1e3
Model = TBS.Keps_Solver(500, lat, depth, dp_x, dp_y, rho, u10,v10, outdir, "Vars", init_u=[0.001,0.1], init_v=[0.001,0.1], mode='verbose')
